...
void run_bw_accuracy()
{
    ...
    RUN_BW_VS_SOS(13, MatchedZ, matchedz);
    RUN_BW_VS_SOS(14, MatchedZ, matchedz);
    RUN_BW_VS_SOS(15, MatchedZ, matchedz);
    RUN_BW_VS_SOS(16, MatchedZ, matchedz);
    RUN_BW_VS_SOS(17, MatchedZ, matchedz);
    RUN_BW_VS_SOS(18, MatchedZ, matchedz);
    RUN_BW_VS_SOS(19, MatchedZ, matchedz);
    RUN_BW_VS_SOS(20, MatchedZ, matchedz);
    RUN_BW_VS_SOS(21, MatchedZ, matchedz);
    RUN_BW_VS_SOS(22, MatchedZ, matchedz);
    RUN_BW_VS_SOS(23, MatchedZ, matchedz);
    RUN_BW_VS_SOS(24, MatchedZ, matchedz);
    RUN_BW_VS_SOS(25, MatchedZ, matchedz);
    ...
    RUN_BW_VS_SOS(13, TustinPW, prewarp);
    RUN_BW_VS_SOS(14, TustinPW, prewarp);
    RUN_BW_VS_SOS(15, TustinPW, prewarp);
    RUN_BW_VS_SOS(16, TustinPW, prewarp);
    RUN_BW_VS_SOS(17, TustinPW, prewarp);
    RUN_BW_VS_SOS(18, TustinPW, prewarp);
    RUN_BW_VS_SOS(19, TustinPW, prewarp);
    RUN_BW_VS_SOS(20, TustinPW, prewarp);
    RUN_BW_VS_SOS(21, TustinPW, prewarp);
    RUN_BW_VS_SOS(22, TustinPW, prewarp);
    RUN_BW_VS_SOS(23, TustinPW, prewarp);
    RUN_BW_VS_SOS(24, TustinPW, prewarp);
    RUN_BW_VS_SOS(25, TustinPW, prewarp);
}
