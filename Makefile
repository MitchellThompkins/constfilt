...
.PHONY: format
format:
	find . \( -path "./test_dependencies/googletest" -o -path "./build*" -o -path "./include/constfilt/vendor/*" -o -path "./.worktree/*" -o -path "./profiling" -o -path "./profiling_dependencies" \) -prune \
