...
// =============================================================================
// Elliptic SOS low-pass, ZOH
// =============================================================================

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_2_5rp_40rs_100Hz_1000Hz,
              constfilt::Elliptic<double, 2, constfilt::ZOH>(100.0, 0.5, 40.0,
                                                             1000.0))

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_4_5rp_40rs_100Hz_1000Hz,
              constfilt::Elliptic<double, 4, constfilt::ZOH>(100.0, 0.5, 40.0,
                                                             1000.0))

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_5_5rp_40rs_100Hz_1000Hz,
              constfilt::Elliptic<double, 5, constfilt::ZOH>(100.0, 0.5, 40.0,
                                                             1000.0))

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_6_5rp_40rs_100Hz_1000Hz,
              constfilt::Elliptic<double, 6, constfilt::ZOH>(100.0, 0.5, 40.0,
                                                             1000.0))

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_7_5rp_40rs_100Hz_1000Hz,
              constfilt::Elliptic<double, 7, constfilt::ZOH>(100.0, 0.5, 40.0,
                                                             1000.0))

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_8_5rp_40rs_100Hz_1000Hz,
              constfilt::Elliptic<double, 8, constfilt::ZOH>(100.0, 0.5, 40.0,
                                                             1000.0))

OUTPUT_MATRIX(EllipticSOS_ZOH_LP, lp_3_10rp_60rs_200Hz_4000Hz,
              constfilt::Elliptic<double, 3, constfilt::ZOH>(200.0, 1.0, 60.0,
                                                             4000.0))

// =============================================================================
// Elliptic SOS high-pass, ZOH
// =============================================================================

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_2_5rp_40rs_100Hz_1000Hz,
    constfilt::Elliptic<double, 2, constfilt::ZOH, constfilt::HighPass>(
        100.0, 0.5, 40.0, 1000.0))

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_4_5rp_40rs_100Hz_1000Hz,
    constfilt::Elliptic<double, 4, constfilt::ZOH, constfilt::HighPass>(
        100.0, 0.5, 40.0, 1000.0))

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_5_5rp_40rs_100Hz_1000Hz,
    constfilt::Elliptic<double, 5, constfilt::ZOH, constfilt::HighPass>(
        100.0, 0.5, 40.0, 1000.0))

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_6_5rp_40rs_100Hz_1000Hz,
    constfilt::Elliptic<double, 6, constfilt::ZOH, constfilt::HighPass>(
        100.0, 0.5, 40.0, 1000.0))

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_7_5rp_40rs_100Hz_1000Hz,
    constfilt::Elliptic<double, 7, constfilt::ZOH, constfilt::HighPass>(
        100.0, 0.5, 40.0, 1000.0))

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_8_5rp_40rs_100Hz_1000Hz,
    constfilt::Elliptic<double, 8, constfilt::ZOH, constfilt::HighPass>(
        100.0, 0.5, 40.0, 1000.0))

OUTPUT_MATRIX(
    EllipticSOS_ZOH_HP, hp_3_10rp_60rs_200Hz_4000Hz,
    constfilt::Elliptic<double, 3, constfilt::ZOH, constfilt::HighPass>(
