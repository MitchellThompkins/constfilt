...
## with a single change: __ellip_ws invokes fminbnd with an explicit TolX of
## 1e-15 instead of the ~1e-4 Octave default.  The loose default propagated
## into analog pole locations at the ~1e-6 level, corrupting the reference.
##
...
function ws=__ellip_ws(n, rp, rs)
  ...
  ## contaminates downstream pole locations.  See docs/elliptic.md.
