...
set(CMAKE_C_FLAGS_INIT "--target=arm-none-eabi -ffreestanding -nostdinc")
set(CMAKE_CXX_FLAGS_INIT "--target=arm-none-eabi -ffreestanding -nostdinc -nostdinc++ -isystem ${ARM_CXX_INC} -isystem ${ARM_CXX_INC}/arm-none-eabi -isystem ${ARM_GCC_INC} -isystem ${ARM_C_INC}")
